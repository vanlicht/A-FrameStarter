Shader "8ninths/S09_WaterShader"
{
	Properties
	{
...
#include "UnityCG.cginc"
	...
	fixed4 mainColour = tex2D(_MainTex, i.texcoord.xy*0.25 + waterDisplacement * 5);

	return saturate((col * 0.5) + (mainColour * _waterColour * causticColour));
	}
